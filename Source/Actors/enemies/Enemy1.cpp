...

{
        ...
        mDrawComponent = new AnimatorComponent(
               this,
               "../Assets/Sprites/enemy1/enemy1.png",
...
void Enemy1::OnHorizontalCollision(const float minOverlap, AABBColliderComponent* other)
{
...
void Enemy1::OnVerticalCollision(const float minOverlap, AABBColliderComponent* other)
{
