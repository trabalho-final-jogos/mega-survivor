    ...
    : Actor(game)
{
    ...
    mDrawComponent = new AnimatorComponent(
               this,
               "../Assets/Sprites/enemy4/enemy4.png",
               "../Assets/Sprites/enemy4/enemy4.json",
               Game::TILE_SIZE,
               Game::TILE_SIZE
       );
...
void Bat::OnUpdate(float deltaTime)
{
    ...
    if (pos.x < camPos.x - buffer || pos.x > camPos.x + Game::VIRTUAL_WIDTH + buffer ||
        pos.y < camPos.y - buffer || pos.y > camPos.y + Game::VIRTUAL_HEIGHT + buffer)
    {
...
void Bat::OnHorizontalCollision(const float minOverlap, AABBColliderComponent* other)
{
...
void Bat::OnVerticalCollision(const float minOverlap, AABBColliderComponent* other)
{
