...

{
    // A classe base pode criar um RectComponent simples como placeholder
        mDrawComponent = new AnimatorComponent(
            this,
            "../Assets/Sprites/weapons/texture.png",
            "../Assets/Sprites/weapons/texture.json",
            Game::TILE_SIZE,
            Game::TILE_SIZE);
        mRigidBodyComponent = new RigidBodyComponent(this, 1.0f, 0.0f, false); // Gravidade false
...
{
    Actor::OnUpdate(deltaTime); // Necessário para atualizar componentes (RigidBody)
