...
IceProjectile::IceProjectile(Game* game, int width, int height)
    : Projectile(game, width, height) // Chama o construtor da base (que carrega o spritesheet)
{
...
void IceProjectile::OnHorizontalCollision(const float minOverlap, AABBColliderComponent* other)
{
...
void IceProjectile::OnVerticalCollision(const float minOverlap, AABBColliderComponent* other)
{
