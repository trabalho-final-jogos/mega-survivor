...
class Vector2 {
 public:
  ...
  [[nodiscard]] static Vector2 Lerp(const Vector2& a,
                                    const Vector2& b,
                                    float f) {
    return a + f * (b - a);
  }
  ...
  [[nodiscard]] static Vector2 Transform(const Vector2& vec,
...
class Vector3 {
 public:
  ...
  // Lerp from A to B by f
  [[nodiscard]] static Vector3 Lerp(const Vector3& a,
                                    const Vector3& b,
                                    float f) {
    return a + f * (b - a);
  }
  ...
  [[nodiscard]] static Vector3 Transform(const Vector3& vec,
...
inline constexpr Vector3 Vector3::Infinity(Math::Infinity,
                                           Math::Infinity,
                                           Math::Infinity);
...
class Vector4 {
 public:
  ...
  // Lerp from A to B by f
  [[nodiscard]] static Vector4 Lerp(const Vector4& a,
                                    const Vector4& b,
                                    float f) {
    return a + f * (b - a);
  }
...
inline constexpr Vector4 Vector4::Infinity(Math::Infinity,
                                           Math::Infinity,
                                           Math::Infinity,
                                           Math::Infinity);
...
class Matrix4 {
 public:
  ...
  [[nodiscard]] static Matrix4 CreateScale(float xScale,
                                           float yScale,
                                           float zScale) {
  ...
  [[nodiscard]] static Matrix4 CreateLookAt(const Vector3& eye,
  ...
  [[nodiscard]] static Matrix4 CreateOrtho(float width,
                                           float height,
                                           float near,
                                           float far) {
  ...
  [[nodiscard]] static Matrix4 CreateOrtho(float left,
                                           float right,
                                           float bottom,
                                           float top,
                                           float near,
  ...
  [[nodiscard]] static Matrix4 CreatePerspectiveFOV(float fovY,
                                                    float width,
                                                    float height,
                                                    float near,
                                                    float far) {
...
[[nodiscard]] inline bool NearlyEqual(float a,
                                      float b,
                                      float epsilon = 0.001f) {
  return Abs(a - b) <= epsilon;
}

[[nodiscard]] inline bool NearlyEqual(const Vector2& a,
                                      const Vector2& b,
                                      float epsilon = 0.001f) {
  return NearlyEqual(a.x, b.x, epsilon) && NearlyEqual(a.y, b.y, epsilon);
}

[[nodiscard]] inline bool NearlyEqual(const Vector3& a,
                                      const Vector3& b,
                                      float epsilon = 0.001f) {
  return NearlyEqual(a.x, b.x, epsilon) && NearlyEqual(a.y, b.y, epsilon) &&
...
[[nodiscard]] inline bool NearlyEqual(const Quaternion& a,
                                      const Quaternion& b,
                                      float epsilon = 0.001f) {
  return NearlyEqual(a.x, b.x, epsilon) && NearlyEqual(a.y, b.y, epsilon) &&
